...
| ----------------------- | -------------------------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `columns`               | **Column[]**                           | -                | Array of elements to display list of links                                                                          |
| `bottomLinks`           | **BottomLink[]**                       | -                | Array of links to display at the bottom of the footer.                                                                                    |
| `copyText`              | **string** &#124; **ReactElement**     | -                | Element to render above bottom links                                                                 |
| `aux`                   | **AuxProps**                           | -                | Elements to render between columns and bottom links, used for social media info.                                                                    |
| `topElement`            | **ReactNode**                          | -                | Custom component to render at the top of the footer, commonly used for brand logo.                                                            |
| `bottomLinksClassName`  | **string**                             | -                | Custom classname for bottomLinks container.                                                              |
| `sectionDivider`        | **boolean**                            | false            | Flag to display an horizontal line between sections.                                                         |
| `footerDivider`         | **boolean**                            | false            | Flag to display a border top in footer element.                                                         |
| `containerDivider`      | **boolean**                            | false            | Flag to display a border top in footer container child.                                                         |
| `transparent`           | **boolean**                            | false            | Flag to set transparent background color to footer element.                                                         |

## aux Props
| Name              | Type            | Default value    | Description                                                                                                                  |
| ----------------- | --------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `badges`          | **ReactNode**   | -                | Custom element to render apps store badges.                                                                          |
| `socialMedia`     | **ReactNode**   | -                | Custom element to render social media button icons.                                                                                    |
| `extraContent`    | **ReactNode**   | -                | Custom element to render aditional content align at the end of the flex container                                                                 |

## Examples

### Footer with aux prop
<Footer />


```jsx
// How to use Footer all props
