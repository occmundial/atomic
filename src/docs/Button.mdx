...
> <Text info>The ghostPink theme is deprecated, since it doesn't match with any of the new themes.</Text>
...
<Demo title="Button with only an icon">
  <Flexbox
    ...
    wrap="wrap"
  >
    <Button size="lg" iconLeft="search" style={{ margin: spacing.tiny }} />
...
function Component() {
  return (
    <>
      <Button size="lg" iconLeft="search" />
